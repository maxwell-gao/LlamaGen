...
class ProtoTokenOptimizer:
    ...
    def construct_input_embeddings(self, seq_length):
        ...
        """
        # First position is e_t, the rest are m
...
def verify_proto_tokens(model, tokenizer, visual_tokens, args):
    """
...
def main(args):
    ...
    optimizer = verify_proto_tokens(model, tokenizer, visual_tokens, args)
    ...
    print(f"✓ Proto-tokens Parameters: 2 × {model.config.hidden_size} = {2 * model.config.hidden_size}")
